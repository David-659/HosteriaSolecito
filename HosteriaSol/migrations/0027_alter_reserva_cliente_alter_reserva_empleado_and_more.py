# Generated by Django 5.1.6 on 2025-04-01 23:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('HosteriaSol', '0026_alter_reserva_cliente_alter_reserva_empleado_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='reserva',
            name='cliente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fk04_idCliente', to='HosteriaSol.usuario'),
        ),
        migrations.AlterField(
            model_name='reserva',
            name='empleado',
